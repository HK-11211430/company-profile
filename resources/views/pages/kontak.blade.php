            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                <a href="tel:+6281234567890" class="hover:text-blue-600">085959120044</a>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                <a href="mailto:smkaknusabangsa@gmail.com" class="hover:text-blue-600">smkaknusabangsa@gmail.com</a>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                ...
                                Sabtu: 09:00 - 12:00 (Khusus Piket Sabtu)<br>
                                Minggu: Tutup
                            </p>
                        </div>
                    </div>
                ...
                <div class="mt-6 bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/SMK.AKNB/" class="text-gray-600 hover:text-blue-600" target="_blank" rel="noopener">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="https://x.com/Smkaknusabangsa" class="text-gray-600 hover:text-blue-600" target="_blank" rel="noopener">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                        </a>
                        <a href="https://www.instagram.com/smkaknusabangsa/" class="text-gray-600 hover:text-blue-600" target="_blank" rel="noopener">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <form action="{{ route('kontak.send') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <button type="submit" 
                                class="w-full md:w-auto px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                Kirim Pesan
                            </button>
                        </div>
                    </form>
        ...
        <div class="mt-12">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="aspect-w-16 aspect-h-9">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.6664463317306!2d106.82496851431011!3d-6.17544426220799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5d2e764b12d%3A0x3d2ad6e1e0e9bcc8!2sMonumen%20Nasional!5e0!3m2!1sen!2sid!4v1636424326758!5m2!1sen!2sid" 
