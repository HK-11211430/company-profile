...
<head>
    ...
    <title>@yield('title', 'Company Profile') - {{ config('app.name') }}</title>
    ...
    <style>
        ...
        /* small utility to keep content centered and airy */
        .site-container { max-width: 1200px; margin: 0 auto; padding-left: 1rem; padding-right: 1rem; }
    </style>
</head>
<body class="min-h-screen bg-gray-50 font-sans antialiased text-gray-800">
    <!-- Navigation -->
    <header x-data="{ open: false }" class="bg-white shadow-sm sticky top-0 z-30">
        <div class="site-container flex items-center justify-between h-20">
            <a href="{{ route('home') }}" class="flex items-center gap-3">
                <img src="https://pbs.twimg.com/profile_images/950554097177915393/YD1TFBSo_400x400.jpg" alt="logo" class="h-8 w-8 rounded-md object-cover">
                <div>
                    <div class="text-lg font-bold text-blue-600">{{ config('app.name') }}</div>
                    <div class="text-xs text-gray-500 -mt-1">Nusa Bangsa Bisa, Nusa Bangsa Juara</div>
                </div>
            </a>
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('kontak') }}" class="hidden sm:inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700">Hubungi Kami</a>

                <!-- Mobile menu button -->
                <button @click="open = !open" aria-expanded="false" aria-controls="mobile-menu" class="lg:hidden p-2 rounded-md text-gray-600 hover:bg-gray-100">
        ...
        <div class="site-container py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-2">
                    ...
                    <p class="text-gray-600">Kami berkomitmen menghadirkan Jurusan dan layanan berkualitas untuk menunjang kebutuhan Anda. Hubungi kami untuk solusi terbaik.</p>
                    <div class="mt-4 flex items-center space-x-3">
                        <a href="#" class="text-gray-400 hover:text-gray-600" aria-label="Facebook">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-600">JL KH Soleh Iskandar, Kota Bogor</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-6 w-6 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                            </svg>
                            <span class="text-gray-600">+62 85959120044</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-6 w-6 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            <span class="text-gray-600">smkaknusabangsa@gmail.com</span>
                        </li>
                    </ul>
                </div>
            </div>
